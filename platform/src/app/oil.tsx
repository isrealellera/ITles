  ...
  return (
    <div className="space-y-2 text-sm text-muted-foreground">
      ...
      <ol className="list-decimal space-y-1 pl-5">
        ...
        <li>
          <b className="text-foreground">Сигнализатор или датчик уровня</b> — на дискретный или аналоговый вход трекера (например, термисторный сигнализатор СУЖ — «ниже минимума»).
        </li>
        <li>
